...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy:
      play_smithy(currentPlayer, handPos, state);
    case village:
    ...
    case steward:
		play_steward(choice1, choice2, choice3, currentPlayer, handPos, state);
...
* Function: add 3 cards to deck
* Introduce bug: add 4 cards to the deck instead of 3
* Input: currentPlayer, handPos, state
* Output: none
*/
...
* Output: none
*/
int play_adventurer(int currentPlayer, int handPos, struct gameState* state){
	int temphand[MAX_HAND];// moved above the if statement
	int drawntreasure=1;
	int cardDrawn;
	int z = 0;
...
* Function: Current Player draw 4 cards, add 1 buy, and other players draw a card
* Introduce bug: Current Player draw 5 cards instead of 4
* Input: currentPlayer, handPos, state
* Output: none
*/
int play_council_room(int currentPlayer, int handPos, struct gameState* state){
	 int i;
	 //+5 Cards
      for (i = 0; i < 5; i++)
	{
...
int play_steward(int choice1, int choice2, int choice3, int currentPlayer, int handPos, struct gameState *state){
	if (choice1 == 1)
	{
	  //+2 cards
	  drawCard(currentPlayer, state);
